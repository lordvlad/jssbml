...
class Document {
  constructor (opt = {}) {
    ...
    props.level = opt.level || 3
    props.version = opt.version || 1
    props.xmlns = opt.xmlns || Document.xmlns(props.level)
    assign(this, props, namespaces(opt))
  }
}
